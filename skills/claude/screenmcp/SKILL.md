...
Claude Code watches an existing personal skills directory live; restart it only if ScreenMCP had to
create that top-level directory or the MCP tools were already initialized.
